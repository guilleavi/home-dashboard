...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__ProductClient<T, Null = never> implements PrismaPromise<T> {
    ...
    instances<T extends Product$instancesArgs= {}>(args?: Subset<T, Product$instancesArgs>): PrismaPromise<Array<ProductInstanceGetPayload<T>>| Null>;
  ...
  type GetProductInstanceGroupByPayload<T extends ProductInstanceGroupByArgs> = PrismaPromise<
    Array<
  ...
  export interface ProductInstanceDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends ProductInstanceAggregateArgs>(args: Subset<T, ProductInstanceAggregateArgs>): PrismaPromise<GetProductInstanceAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, ProductInstanceGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetProductInstanceGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__ProductInstanceClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
